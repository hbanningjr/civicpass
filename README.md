...
- **Admin Portal** — authorize and revoke trusted issuers, full system control
- **Issuer Portal** — issue and revoke voter credentials for specific elections
- **Verifier Portal** — verify credentials and check voters in at the polling place
...
2. **At the Polling Place** — The voter presents their wallet address
...
| -------- | --------------- | --------------------------------------------- |
| Admin    | Admin Portal    | Authorize/revoke issuers, full system control |
| Issuer   | Issuer Portal   | Issue and revoke voter credentials            |
| Verifier | Verifier Portal | Verify credentials and check voters in        |
...
- Role-based access ensures each user sees only their permitted functions
